...
<div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 fon padding_left_right_none">
 ...
 <img class="img-responsive" src="/bitrix/templates/partner/img/men.png">
			...
			<h3 class="col-lg-6 col-sm-6 col-xs-12 col-md-6 banners padding_left_right_none"><span class="banner-span pull-right">Организация любой деятельности — коммерческой, бюджетной или некоммерческой —<br>
 ...
 <!--банер--> <!--Сервисы--> <section class="services">
<div class="container">
	<div class="row">
		 <!-- Nav tabs -->
		<div class="col-lg-6 col-md-8 col-xs-12 col-sm-12 col-lg-offset-3 col-md-offset-2 col-sm-offset-0 col-xs-offset-0 tabs">
			<ul class="nav nav-tabs nav-tabs-servicess" role="tablist">
				<li class="active" role="presentation"><a role="tab" aria-controls="home" href="#home" data-toggle="tab">Юридическим лицам</a></li>
				<li role="presentation"><a role="tab" aria-controls="profile" href="#profile" data-toggle="tab">физическим лицам</a></li>
			</ul>
			 <!-- Tab panes -->
		</div>
...
<!--Сервисы--> <!--успешных дел--> <section class="del">
<div class="container">
	<div class="row">
 <span class="title-del">Более 500 успешных дел</span> <span class="subtitle-del">Убедитесь, что имеете дело с настоящими профессионалами</span>
	...
	Array(
		...
		"LIST_ACTIVE_DATE_FORMAT" => "d.m.Y",
		"LIST_FIELD_CODE" => array(0=>"",1=>"",),
		"LIST_PROPERTY_CODE" => array(0=>"",1=>"download_file_pdf",2=>"",),
		"HIDE_LINK_WHEN_NO_DETAIL" => "N",
		"DISPLAY_NAME" => "Y",
		"META_KEYWORDS" => "-",
		"META_DESCRIPTION" => "-",
		...
		"DETAIL_ACTIVE_DATE_FORMAT" => "d.m.Y",
		"DETAIL_FIELD_CODE" => array(0=>"",1=>"",),
		"DETAIL_PROPERTY_CODE" => array(0=>"",1=>"download_file_pdf",2=>"",),
		"DETAIL_DISPLAY_TOP_PAGER" => "N",
		"DETAIL_DISPLAY_BOTTOM_PAGER" => "N",
		"DETAIL_PAGER_TITLE" => "Страница",
		"DETAIL_PAGER_TEMPLATE" => "",
		...
		"MESSAGE_404" => "",
		"SEF_FOLDER" => "./dela/",
		"SEF_URL_TEMPLATES" => array("news"=>"","section"=>"/dela/","detail"=>"#ELEMENT_CODE#/",),
		"VARIABLE_ALIASES" => Array(),
		"VARIABLE_ALIASES" => Array(
		)
	)
);?> <a href="/dela"><button class="btn btn-lazur center">Все дела</button></a>
		</div>
	</div>
</div>
 </section>
<!--успешных дел--> <!--News--> <section class="news">
<div class="container">
	 <?$APPLICATION->IncludeComponent(
	"bitrix:news",
	"home_news",
	Array(
		...
		"LIST_ACTIVE_DATE_FORMAT" => "d.m.Y",
		"LIST_FIELD_CODE" => array(0=>"",1=>"",),
		"LIST_PROPERTY_CODE" => array(0=>"news_type",1=>"",),
		"HIDE_LINK_WHEN_NO_DETAIL" => "N",
		"DISPLAY_NAME" => "Y",
		"META_KEYWORDS" => "-",
		"META_DESCRIPTION" => "-",
		...
		"DETAIL_ACTIVE_DATE_FORMAT" => "d.m.Y",
		"DETAIL_FIELD_CODE" => array(0=>"",1=>"",),
		"DETAIL_PROPERTY_CODE" => array(0=>"news_type",1=>"",),
		"DETAIL_DISPLAY_TOP_PAGER" => "N",
		...
		"MESSAGE_404" => "",
		"SEF_FOLDER" => "./novosti",
		"SEF_URL_TEMPLATES" => array("news"=>"./novosti","section"=>"","detail"=>"/#ELEMENT_CODE#/",),
		"VARIABLE_ALIASES" => Array(),
		"VARIABLE_ALIASES" => Array(
		)
	)
